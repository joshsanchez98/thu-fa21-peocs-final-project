...
parser.add_argument("--algos", nargs="+", type=str, default=["PPO"])
...
def uniform_sample(x, y, x0, ):
	# switched order of line 20 & 21, and added extrapolate to avoid plotting problems
	x_new = np.arange(x0, args.n_steps, args.steps_int)
	flinear = interpolate.interp1d(x, y, fill_value = "extrapolate")
	y_new = flinear(x_new)
	return x_new, y_new
