...
parser.add_argument("--algo", type=str, help="algorithm used: [REINFROCE, PPO, TRPO]", default="PPO")
...
parser.add_argument("--n_episodes", type=int, help="# of episodes to test the policy", default=30)
